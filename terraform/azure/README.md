...
3. Install the required configuration management applications.
   ...
   **Note**: You can create an alias to execute `make` with this `Makefile` from any directory:
    ...
    alias make-sf-azure="make --directory $PWD"
    ```
...
2. Open the Spotfire server web UI, accessible via the Azure Application Gateway address: `http://<your-azure-app-gw-ip-address>`.
